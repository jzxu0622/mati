...
[ M_in_tg1, M_ex_tg1 ] = mati.Physics.generalSolution_blochEQ( kin,kex,kin,kex,vin,1-vin,tg1 );
Ain=kin+model.pulse.b./model.pulse.tdiff.*ADC;
Aex=kex+model.pulse.b./model.pulse.tdiff.*Dex;
[ M_in_tg2, M_ex_tg2 ] = mati.Physics.generalSolution_blochEQ( Ain,Aex,kin,kex,M_in_tg1,M_ex_tg1,tg2-tg1 );
[ M_in_tg3, M_ex_tg3 ] = mati.Physics.generalSolution_blochEQ( kin,kex,kin,kex,M_in_tg2,M_ex_tg2,tg3-tg2 );
...
Ain=kin;
Aex=kex;
[ M_in_tg1, M_ex_tg1 ] = mati.Physics.generalSolution_blochEQ( Ain,Aex,kin,kex,vin,1-vin,tg1 );
Ain=kin+model.pulse.b./model.pulse.tdiff./model.pulse.n/4.*ADC;
Aex=kex+model.pulse.b./model.pulse.tdiff./model.pulse.n/4.*Dex;
[ M_in_tg2, M_ex_tg2 ] = mati.Physics.generalSolution_blochEQ( Ain,Aex,kin,kex,M_in_tg1,M_ex_tg1,model.pulse.delta/2);
[ M_in_tg3, M_ex_tg3 ] = mati.Physics.generalSolution_blochEQ( kin,kex,kin,kex,M_in_tg2,M_ex_tg2,model.pulse.Delta-model.pulse.delta/2);
[ M_in_tg4, M_ex_tg4 ] = mati.Physics.generalSolution_blochEQ( Ain,Aex,kin,kex,M_in_tg3,M_ex_tg3,model.pulse.delta/2);
[ M_in_tg5, M_ex_tg5 ] = mati.Physics.generalSolution_blochEQ( kin,kex,kin,kex,M_in_tg4,M_ex_tg4,tg1);
