...
2.	There are four subclasses of mati.SignalModel, corresponding to three different models
    a.	mati.IMPULSED for estimation of mean cell size
    b.	mati.MRICytometry for estimation of cell size distribution
    c.	mati.JOINT for simultaneous estimation of mean cell size and transcytolemmal water exchange
